...
ggarrange(B6CAST, B6LEWES, B6PWK, B6minor, CASTLEWES, CASTPWK, CASTminor, LEWESPWK, LEWESminor, PWKminor,
          ...
          ncol = 4, nrow = 4)
```
##Run without minor and major sat consensus sequences
Iteration of CENPA reads without consensus
Copy directory /projects/dumont-lab/uma/CENPA_ChIP/readscore/stylo_randomization
Delete minor and major satellite consensus text files from each replicate folder
path is /projects/dumont-lab/uma/CENPA_ChIP/readscore/stylo_randomization/woconsensus
...
for (i in 1:1){
   ...
   corpusdirectory <- paste("/projects/dumont-lab/uma/CENPA_ChIP/readscore/stylo_randomization/woconsensus/rep", i, sep = "")
...
```{r}
setwd("/projects/dumont-lab/uma/CENPA_ChIP/readscore/")
write.table(PCA1, file = 'PCA_RandomSample_1000_woconsensus_normReadcount_normReadscore.txt')
write.table(CA1, file = 'CA_RandomSample_1000_woconsensus_normReadcount_normReadscore.txt')
```

stylo w = 1 and without consensus sequence
Note distance cutoff values
...
```{r}
setwd("/projects/dumont-lab/uma/CENPA_ChIP/readscore/")
CAiter <- read.table(file = 'CA_RandomSample_1000_woconsensus_normReadcount_normReadscore.txt')
```
